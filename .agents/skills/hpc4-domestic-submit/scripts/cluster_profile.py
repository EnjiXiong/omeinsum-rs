...
``.agents/skills/hpc4-domestic-submit/profiles/`` holding everything a cluster-aware skill needs:
...
* ``hpc4_harness_slurm.sh`` shells out to the ``--field`` CLI for ssh/repo fields,
...
PROFILES_DIR = ".agents/skills/hpc4-domestic-submit/profiles"
...
# --------------------------------------------------------------------------- #
# CLI (consumed by hpc4_harness_slurm.sh)
# --------------------------------------------------------------------------- #
