use omeinsum::static_plan::{build_plan_bundle_with_preprocessing, LeafPreprocessing};
...
pub(crate) fn run(
    ...
    let bundle = build_plan_bundle_with_preprocessing(&network, realness_tol, leaf_preprocessing)
